            ...
            <div class="col-md-6 offset-md-3">
                ...
                <form action="{{route('save-category')}}" method="Post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input id="type_name" name="category_name" class="form-control form-control-lg" type="text"
                               placeholder="Enter Category Name" required
                               style="border-radius: 20px;">

                        <label for="type_name">Category Shortname</label>
                        <input id="type_name" name="short_name" class="form-control form-control-lg" type="text"
                               placeholder="Short Name" required
                               style="border-radius: 20px;">

                        <span
                            style="color:red"><u>{{$errors->has('category_name')? $errors->first('category_name'):""}}</u></span>
                    ...
                    <div class="form-row">
                        ...
                        <span class="icon text-white-50">
                            ...
                            <span
                                style="color:red"><u>{{$errors->has('category_image')? $errors->first('category_image'):""}}</u></span>
